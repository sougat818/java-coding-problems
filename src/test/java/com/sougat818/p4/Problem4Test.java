...
public class Problem4Test {
    ...
    public void testSolution1() throws IOException {
        ...
        Assert.assertEquals("[177.71.128.21, 168.41.191.40, 72.44.32.10]",
                metricSummary.getTopIps().keySet().toString());
        Assert.assertArrayEquals(new Long[] {3L, 4L, 3L},
                metricSummary.getTopIps().values().toArray(new Long[] {}));

        Assert
                .assertEquals("[\"GET /faq/how-to/, \"GET /asset.js, \"GET /docs/manage-websites/]",
                        metricSummary.getTopUrls().keySet().toString());
        Assert.assertArrayEquals(new Long[] {1L, 1L, 2L},
    ...
    public void testSolution2() throws IOException {
        ...
        Assert.assertEquals("[\"GET /twiki/bin/view/Main/WebHome, \"GET /twiki/pub/TWiki/TWikiLogos/twikiRobot46x50.gif, \"GET /]",
                metricSummary.getTopUrls().keySet().toString());
